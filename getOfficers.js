...
var SERVICE_ACCOUNT =
  (_a = process.env.SERVICE_ACCOUNT) !== null && _a !== void 0 ? _a : '{}';
        ...
        case 1:
          ...
          rows.forEach(function (row) {
            ...
            if (committees.has(row[0])) {
              ...
              var committee = row[0];
              currCommittee =
                (_a = committees.get(committee)) !== null && _a !== void 0
                  ? _a
                  : ''; // empty string means ACM Board
              return;
            }
            ...
            if (!image) {
              ...
              image = 'https://drive.google.com/uc?export=download&id='.concat(
                fileID,
              );
            }
            // create officer
